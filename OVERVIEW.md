...
**当前状态**: v0.3.1 已发布（665 测试全绿）— 核心引擎 + GitHub/Notion 双向同步 + 写回闭环 + 知识文档层 + 工作台 + 三省 Protocol + 全文搜索 + MCP Server (22 tools)
...
*读完这个文件，你应该知道：我们在建什么（FocalPoint — AI 认知操作系统）、建到哪了（v0.3.1 — 记忆引擎+知识层+工作台+三省 已完成）、下一步做什么（v0.4 多 Agent 协作）。*
